...
$share_urls = [
	...
	'instagram' => '', // Instagram does not support direct URL sharing; link to profile or omit.
...
$network_labels = [
	...
	'instagram' => __( 'Share on Instagram', 'afca-blocks-library' ),
...
foreach ( $enabled_networks as $network_id ) {
	...
	// Instagram has no direct share URL — skip the link wrapper if empty.
	if ( empty( $share_url ) ) {
		continue;
	}
